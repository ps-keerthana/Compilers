...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_INT_CONST = 32,                 /* INT_CONST  */
  YYSYMBOL_FLOAT_CONST = 33,               /* FLOAT_CONST  */
...
static const char *const yytname[] =
{
  ...
  "VOID", "DOUBLE", "SHORT", "LONG", "IF", "ELSE", "FOR", "WHILE", "DO",
  "SWITCH", "CASE", "DEFAULT", "BREAK", "CONTINUE", "RETURN", "STRUCT",
  "TYPEDEF", "ENUM", "UNION", "SIZEOF", "AUTO", "CONST", "STATIC",
  "EXTERN", "REGISTER", "IDENTIFIER", "INT_CONST", "FLOAT_CONST",
  "CHAR_CONST", "STRING_LITERAL", "OPERATOR", "'('", "')'", "'{'", "'}'",
  "'['", "']'", "';'", "','", "'.'", "':'", "'?'", "$accept", "program",
  "token_list", "token", YY_NULLPTR
};
